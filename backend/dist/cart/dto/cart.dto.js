...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Product variant UUID' }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], AddCartItemDto.prototype, "variantId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Quantity to add', example: 1 }),
...
], AddCartItemDto.prototype, "customization", void 0);
class UpdateCartItemDto {
    quantity;
}
exports.UpdateCartItemDto = UpdateCartItemDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'New quantity (0 removes the item)', example: 2 }),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
